...
function CardSobre({nome, imagem, cargo, responsavel, linkedin, github}: CardSobreProps) {
    return (
        <div className=" flex items-center justify-center p-12 md:p-8 md:justify-start md:items-start md:-mx-2 md:left-10 ">
            ...
            <header className='flex flex-col items-center justify-start py-8 px-6 bg-[var(--color-dark-slate)] text-white font-bold text-2xl gap-3.5 pb-0'>
                <img 
                    src={imagem}
            ...
            <div className='flex flex-col items-center justify-center p-8 text-2xl bg-[var(--color-light-gray)] gap-6 min-h-70 md:min-h-[25vh] pt-3'>
                <div className="w-full flex flex-col items-center gap-2">
                    <p className="text-center">{cargo}</p>
                    <p className="text-center text-lg md:text-xl">{responsavel}</p>
                </div>
